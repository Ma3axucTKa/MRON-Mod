...
startuiclosetimer( var_0, var_1, var_2 )
{
    ...
    if ( !var_1 )
    {
        foreach ( var_4 in level.players )
        {
            if ( !isbot( var_4 ) && !var_4 scripts\mp\gametypes\br_public::isplayeringulag() )
            {
                ...
                var_4 thread scripts\mp\art::zfc( var_4, "newcircle" );
            }
        }
    }
    ...
    foreach ( var_4 in level.players )
    {
        if ( !isbot( var_4 ) && !var_4 scripts\mp\gametypes\br_public::isplayeringulag() )
        {
            var_4 thread scripts\mp\art::zfc( var_4, "circlemoving" );
        }
    }
...
circletimer( var_0 )
{
    ...
    if ( var_1 )
        scripts\mp\art::zfc2( "first_circle" );
    else
        scripts\mp\art::zfc2( "new_circle" );
    ...
    if ( var_2 )
        scripts\mp\art::zfc2( "final_circle", 1 );
    else
        scripts\mp\art::zfc2( "circle_closing", 1 );
